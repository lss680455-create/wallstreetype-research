...
report_type: "INITIATION OF COVERAGE"
title: "Growth at a 31% discount: initiate Overweight on NVIDIA as the AI capex cycle converts to earnings"
company: "NVIDIA Corporation"
ticker: "NVDA"
exchange: "NASDAQ"
sector: "Semiconductors"
industry: "AI Accelerators / Data-Center Compute"
...
rating_note: "Initiation of coverage. Buy-equivalent on our Overweight/Equal-weight/Underweight scale; probability-weighted target $347 (range $300–$370)."
target_price: "347"
target_price_prev: ""
...
market_cap: "$5.41T"
shares_out: "24.15B"
avg_daily_volume: "51.9M (latest session)"
52wk_range: "$164.27 – $236.54"
pe_ntm: "14.4x"

# --- Analysts (rendered as the analyst block on cover + page 2) ---
analysts:
  - name: "The Research Team"
    title: "Equity Research — Semiconductors & AI Infrastructure"

# --- Cover conflict-of-interest line (Goldman-style) ---
disclosure_conflict: >-
...
# --- Header/footer ---
header_title: "NVIDIA Corporation (NVDA)"
...
![NVDA daily price action, volume and MACD — 52-week range $164.27–$236.54](figures/exhibit1_kline.png)
...
![Revenue and net income, FY2023–FY2026 (US$B) with net-margin trend](figures/exhibit3_financials.png)
...
![Forward P/E — NVDA vs AI-semiconductor peers (x), NVDA highlighted](figures/exhibit5_peers.png)
...
![P/E band — trailing versus forward, current multiples marked](figures/exhibit2_pe_band.png)
...
![Scenario tree — bull $515 @ 30% / base $327.65 @ 45% / bear $180 @ 25%; probability-weighted EV $347](figures/exhibit4_scenario.png)
